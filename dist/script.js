...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])('.glazing_slider', '.glazing_block > a', '.glazing_content', 'active');
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["timer"])(2022, 12, 9);
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_validation__WEBPACK_IMPORTED_MODULE_1__["onlyNum"])('#width');
  Object(_validation__WEBPACK_IMPORTED_MODULE_1__["onlyNum"])('#height');

  var bindActionChange = function bindActionChange(event, elem, prop) {
...
var forms = function forms(state) {
  ...
  Object(_validation__WEBPACK_IMPORTED_MODULE_5__["onlyNum"])('input[name="user_phone"]');

  var inputsClear = function inputsClear() {
  ...
  var buttonsDisable = function buttonsDisable(value) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('https://jsonplaceholder.typicode.com/posts', data).then(function (res) {
...
var image = function image() {
  var mainBlock = document.querySelector('.works'),
...
var modals = function modals() {
  ...
  var bindModal = function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var closingAllWindows = function closingAllWindows() {
...
var DAY = 86400000,
    ...
    MINUTE = 60000,
    SECOND = 1000;
var timer = function timer(year, month, day) {
  var hours = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
  var date = new Date(year, month - 1, day, hours);

  var timeLast = function timeLast(date) {
    var dif = date - Date.now();
    var mainTime = {
      days: 0,
      hours: 0,
      minutes: 0,
  ...
  var setTimer = function setTimer(timeObject, daySelector, hourSelector, minuteSelector, secondSelector) {
...
/*!**************************************!*\
  !*** ./src/js/modules/validation.js ***!
  \**************************************/
/*! exports provided: onlyNum */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onlyNum", function() { return onlyNum; });
...
var onlyNum = function onlyNum(selector) {
